...
- Report saved to `.a-team/scientist/reports/` with visualizations in `.a-team/scientist/figures/`
...
1) SETUP: Verify Python/packages, create working directory (.a-team/scientist/), identify data files, state [OBJECTIVE].
...
Report saved to: .a-team/scientist/reports/{timestamp}_report.md
