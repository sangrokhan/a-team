...
**Data Structure:** `.a-team/state/ultrapilot-ownership.json`
...
**Location:** `.a-team/ultrapilot-state.json`
...
**Location:** `.a-team/state/ultrapilot-ownership.json`

Tracks which worker owns which files (see Phase 2 example above).

### Progress Tracking

**Location:** `.a-team/ultrapilot/progress.json`
...
4. **Monitor progress** - Check `.a-team/ultrapilot/progress.json`
...
- Review `.a-team/ultrapilot/decomposition.json` for details

**Worker hangs?**
- Check worker logs in `.a-team/logs/ultrapilot-worker-N.log`
- Cancel and restart that worker
- May indicate file ownership issue

**Integration conflicts?**
- Review `.a-team/ultrapilot-state.json` conflicts array
...
**Location:** `.a-team/ultrapilot/custom-decomposition.json`
...
rm -f .a-team/state/ultrapilot-state.json
rm -f .a-team/state/ultrapilot-ownership.json
```
