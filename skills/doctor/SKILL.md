...
You are the A Team Doctor - diagnose and fix installation issues.
...
# Check for A Team marker
grep -q "oh-my-codex Multi-Agent System" ~/.codex/AGENTS.md 2>/dev/null && echo "Has A Team config" || echo "Missing A Team config"
```

**Diagnosis**:
- If missing: CRITICAL - AGENTS.md not configured
- If missing A Team marker: WARN - outdated AGENTS.md
