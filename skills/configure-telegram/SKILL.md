...
Set up Telegram notifications so A Team can message you when sessions end, need input, or complete background tasks.
...
2. Send /newbot
3. Choose a name (e.g., "My A Team Notifier")
...
RESPONSE=$(curl -s -w "\n%{http_code}" \
  ...
  -d "text=A Team test notification - Telegram is configured!")
...
You can also set these via environment variables:
  A_TEAM_TELEGRAM_BOT_TOKEN=123456789:ABCdefGHI...
  A_TEAM_TELEGRAM_CHAT_ID=123456789
...
```bash
export A_TEAM_TELEGRAM_BOT_TOKEN="123456789:ABCdefGHIjklMNOpqrsTUVwxyz"
export A_TEAM_TELEGRAM_CHAT_ID="123456789"
```
