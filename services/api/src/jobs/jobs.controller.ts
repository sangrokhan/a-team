...
export class JobsController {
  ...
  @Get(':jobId/team')
  @ApiOperation({ summary: 'Get team state for team mode job' })
  @ApiOkResponse({ description: 'Team state snapshot' })
  getTeamState(@Param('jobId') jobId: string): Promise<Record<string, unknown>> {
